    ...
    return(
        <section>
            ...
            <div style={{paddingLeft: 20, textAlign: 'left', color: '#061F1E', fontWeight: 400, fontSize: 16, marginBottom: 25}}>
                <p style={{color: '#000'}}>Home / Recently Added Products</p>
            </div>
             <h1 style={{paddingLeft: 20, textAlign: 'left', color: '#000', fontWeight: 800, fontSize: 30, textTransform: 'uppercase'}}>RECENTLY added products</h1>

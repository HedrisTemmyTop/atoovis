    ...
    <div className={classes.FeaturesWrapper}>
      <div className={classes.DetailsMain}>
        <div className={classes.Features}>
          ...
          <ul>
            <h2>Key Features</h2>
            Specifications SKU: DO908TB28QP7MNAFAMZ
            <br />
            Product Line: VINIEL
            <br />
            Model: Baby Dove Rich Moisture Head to Toe Wash 400ml
            <br />
            Production Country: United Kingdom
            <br />
            Size (L x W x H cm): 10 x 10.7 x 20 centimetres
            <br />
            Weight (kg): 0.4
            <br />
            Color: White and Blue
            <br />
            Main Material: Baby dove baby wash head to toe 400ml
            <br />
            Shop by Age: 0-5 Years
            <br />
            From the Manufacturer: N/A
            <br />
            Care Label: N//A Shop Type: Jumia Mall
          </ul>
        </div>
      </div>
    </div>

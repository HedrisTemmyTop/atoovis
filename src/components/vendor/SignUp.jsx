...
const { username, email, password, password_confirmation, phone_number } = formData;
      ...
      {isAuthenticated == null ? (
        <div className="righty">
          ...
          <form action="">
            ...
            {isLoading === null ? <button className="log" onClick={onSignupSubmit}>
            Signup
            </button>:
        ...
        <div className="righty">
          ...
          <h1>Become a vendor today, sell online with Atoovis!</h1>
          <button className="log">
            <Link to="/sidebar">View Dashboard</Link>
          </button>
        </div>
      )}
    </div>
